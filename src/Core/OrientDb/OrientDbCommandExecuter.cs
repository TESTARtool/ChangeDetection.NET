...
public interface IOrientDbCommandExecuter
{
...
public class OrientDbCommandExecuter : IOrientDbCommandExecuter
{
    ...
    public OrientDbCommandExecuter(IHttpClientFactory clientFactory, ILogger<OrientDbId> logger, IOrientDbSignInProvider orientDbSignInProvider)
    {
    ...
    public async Task<byte[]> ExecuteDocumentAsync(OrientDbId id)
    {
        ...
        var url = $"document/{databaseName}/{id.Id.Replace("#", "").Trim()}";
