 ...
 * Project: https://github.com/rneeft/bs5treeview (fix issue and adjusted for bootstrap icon)
 */
; (function ($, window, document, undefined) {
    ...
    var pluginName = "bstreeview",
        defaults = {
            expandIcon: 'bi bi-chevron-down bi-fw',
            collapseIcon: 'bi bi-chevron-right bi-fw',
            indent: 1.25,
